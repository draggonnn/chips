    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            <Link to="/" className="footer-logo">
              <span className="logo-text">Brasil Apple</span>
            </Link>
            <p className="footer-description">
              A melhor experiência em smartphones premium no Brasil. 
              Qualidade, inovação e design em cada produto.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/category/acessorios">Acessórios</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#" onClick={(e) => e.preventDefault()}>Trocas e Devoluções</a></li>
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 Brasil Apple. Todos os direitos reservados.</p>
          <p className="footer-note">
            Este site é uma demonstração e não possui relação com a Apple Inc.
          </p>
        </div>
      </div>
    </footer>
